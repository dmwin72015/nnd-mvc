...
var cornami = {
    ...
    clear:window.setTimeout(clear_cornamiInput, 5000),
    load: function() {
        window.document.onkeydown = function(e) {
            if (cornami.input == cornami.pattern) {
                ...
                clearTimeout(cornami.clear);
                cornami.clear = window.setTimeout(clear_cornamiInput, 5000);
            }
        };
    },
...
function clear_cornamiInput(){
    cornami.clear_input();
}
cornami.load();
module.exports = cornami;
...
var __WEBPACK_AMD_DEFINE_RESULT__;// var moment = require('moment');

!(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
    function log(msg) {
        var time = '【' + Date.now() + '】';
        msg = msg || 'Nothing in log'
...
//# sourceMappingURL=../maps/js/lib.js.map